const CONFIG = {
  ...
  HEO_SITE_CREATE_TIME: '2025-09-01', // 建站日期，用于计算网站运行的第几天

  // 首页顶部通知条滚动内容，如不需要可以留空 []
  HEO_NOTICE_BAR: [
    { title: '欢迎来到我的博客', url: 'https://blog.xiangsiqi.site' }
  ],
  ...
  // 英雄区显示三个置顶分类
  HEO_HERO_CATEGORY_1: { title: '无心插柳', url: '/tag/无心插柳' },
  HEO_HERO_CATEGORY_2: { title: '提桶跑路', url: '/tag/提桶跑路' },
  HEO_HERO_CATEGORY_3: { title: '技术归档', url: '/tag/技术归档' },
