...
const BLOG = {
  API_BASE_URL: process.env.API_BASE_URL || 'https://secret-production-8f3.notion.site/api/v3', // API默认请求地址,可以配置成自己的地址例如：https://[xxxxx].notion.site/api/v3
  // Important page_id！！！Duplicate Template from  https://tanghh.notion.site/02ab3b8678004aa69e9e415905ef32a5
  NOTION_PAGE_ID:
    process.env.NOTION_PAGE_ID ||
    '6e63936163f483139bc2014c46ece813',
  ...
  // 联系方式
  CONTACT_BILIBILI: process.env.NEXT_PUBLIC_CONTACT_BILIBILI || 'https://space.bilibili.com/237243193', // B站主页
